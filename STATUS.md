...
> Tree below predates the 2026-05-10 monorepo restructure + repo rename to
> `qa-toolkit`. Current layout: see top-level [`README.md`](README.md) and
> [`CLAUDE.md`](CLAUDE.md). Everything listed below now lives under
> `extensions/qa-annotator/`.

```
qa-annotator-extension/                  (now renamed → qa-toolkit/extensions/qa-annotator/)
